...
public class AdminLogin implements ActionListener {
	...
	public void initGui() {
		...
		window.setTitle("Teachers window");
		...
		if(e.getSource()==back) {
			...
			window.dispose();
				...
				// if(namecurr=="sujit" && idcurr=="sujit123") {
					...
					// i.initGUI();
				// }
				 if((nametxt.getText().equalsIgnoreCase("sujit") && idtxt.getText().equalsIgnoreCase("sujit123") )
						 || (nametxt.getText().equalsIgnoreCase("BMH") && idtxt.getText().equalsIgnoreCase("bmh123") )){
